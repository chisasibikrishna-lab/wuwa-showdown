    ...
    <div className="min-h-screen bg-[#0a0a0c] relative flex flex-col font-sans selection:bg-white/20 flex-1 w-full mx-auto" style={{ zIndex: 50 }}>
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="bg-[#161922]/90 border border-white/10 rounded-2xl p-8 max-w-sm w-full shadow-2xl relative overflow-hidden backdrop-blur-md">
           ...
           <p className="text-white/40 font-mono text-sm mb-8">Create a new account profile.</p>
           ...
           <form onSubmit={handleRegister} className="flex flex-col gap-4">
             <div>
               <label className="text-white/60 font-bold uppercase tracking-widest text-xs mb-1 block" style={{ fontFamily: "'Rajdhani', sans-serif" }}>Name</label>
             ...
             <div>
               <label className="text-white/60 font-bold uppercase tracking-widest text-xs mb-1 block" style={{ fontFamily: "'Rajdhani', sans-serif" }}>Email Address</label>
             ...
             <button type="submit" className="w-full bg-[#ffcc00] hover:bg-[#ffdf4d] text-black pt-4 pb-3 rounded-lg font-bold tracking-widest text-xl uppercase transition-all shadow-[0_4px_15px_rgba(255,204,0,0.2)] block text-center mt-2" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                Sign Up
             </button>
           </form>
           <p className="text-white/40 text-sm text-center mt-6 uppercase font-bold tracking-widest" style={{ fontFamily: "'Rajdhani', sans-serif" }}>Already have an account? <Link href="/login" className="text-[#ffcc00] hover:underline hover:text-white transition-colors">Login Here</Link></p>
        </div>
      </div>
    </div>
  );
